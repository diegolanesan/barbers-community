    ...
    return (
        <div>
            <div className="bg-hero h-screen bg-center bg-no-repeat bg-cover flex flex-col justify-center h-vh">
                <h1 className="pl-20 pb-4 text-3xl text-white font-bold"> Barber's Community </h1>
            ...
            <div className="text-center mt-16 mb-16">
                <h2 className="text-3xl pb-4 font-bold"> Explore Barber's Community </h2>
                <p className="w-2/5 mx-auto text-lg text-gray-600"> Our expert barbers are classified into three large groups: hair technicians,
                    academic and urban barbers. Find out which one is the best fit for you
                </p>
                <div className="grid-cols-3 gap-8 flex justify-center h-48 my-10">
                    <div className="flex justify-center items-center bg-tecnico-capilar bg-center bg-no-repeat bg-cover w-1/5 rounded-md
                        opacity-100 transition duration-500 ease-in-out hover:shadow-xl transform hover:-translate-y-1 hover:scale-110">
                        <Link to='/hair-technician'> <h3 className="text-white font-bold text-3xl cursor-pointer"> Hair Technician </h3> </Link>
                    </div>
                    <div className="flex justify-center items-center bg-academico bg-center bg-no-repeat bg-cover w-1/5 rounded-md
                        opacity-100 transition duration-500 ease-in-out hover:shadow-xl transform hover:-translate-y-1 hover:scale-110">
                        <Link to='/academic'> <h3 className="text-white font-bold text-3xl cursor-pointer"> Academic Barbers</h3> </Link>
                    </div>
                    <div className="flex justify-center items-center bg-urbano bg-center bg-no-repeat bg-cover w-1/5 rounded-md
                        opacity-100 transition duration-500 ease-in-out hover:shadow-xl transform hover:-translate-y-1 hover:scale-110">
                        <Link to='/urban'> <h3 className="text-white font-bold text-3xl cursor-pointer"> Urban Barbers </h3>  </Link>
                    </div>
                </div>
            </div>
