...
function Error() {
    return (
        <div class="flex flex-col justify-center items-center w-full h-vh">
            ...
            <h1 class="font-prata text-2xl text-secondary font-bold m-6">404 Error</h1>
            ...
            <Link> <button class="p-2 px-4 font-lato text-white font-bold bg-secondary m-6"> Home </button> </Link>
        </div>
    )
}
