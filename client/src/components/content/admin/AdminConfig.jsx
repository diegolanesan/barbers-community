          ...
          <div class="grid bg-white rounded-lg shadow-xl w-11/12  md:w-11/12 mx-12 mt-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mt-5 mx-7">
              <div class="grid grid-cols-1">
                ...
                <input class="py-2 px-3 rounded-lg border-2 border-secondary mt-1 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" 
                        id="firstName"
                        type="text"
            ...
            <div class='flex items-center justify-center  md:gap-8 gap-4 pt-5 pb-5'>
              <button class='w-auto bg-secondary hover:bg-primary rounded-lg shadow-xl font-medium text-white px-4 py-2' onClick={() => handleSubmit()}>Update</button>
            </div>
