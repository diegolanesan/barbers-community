...
export default function Catalog() {
	...
	// Update
	useEffect(() => {
		if (barbersLoaded.slice(0, barbersToShow) !== barbersPerPage)
			setBarbersPerPage(barbersLoaded.slice(0, barbersToShow));
		// eslint-disable-next-line
	...
	const handlePaginate = (e) => {
		...
		setBarbersPerPage(
			barbersLoaded.slice(
				(selectedPage - 1) * barbersToShow,
				selectedPage * barbersToShow
			)
		);
	};
	// ---------------------------------------------- End of Paginate -----------------------------------------------
				...
				<div className="flex flex-col" onClick={handleClick}>
					...
					<div className="ml-2">
						<input
							...
							value="Urban"
							name="Proficiency"
							className="bg-blue-400 hover:bg-blue-600 text-white py-1 px-2 mx-2 mb-3 rounded-lg "
						/>
						<input
							type="button"
							value="Academy"
					...
					<div className="pagination flex justify-center">
						{barbersLoaded && (
							<ReactPaginate
								...
								containerClassName={
									"flex container w-3/5 justify-evenly list-none cursor-pointer absolute bottom-10 "
								}
